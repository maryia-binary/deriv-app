...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@deriv/components"), require("@deriv/shared"), require("@deriv/translations"), require("mobx"), require("mobx-react"), require("react"), require("react-dom"), require("react-router"), require("react-router-dom"));
	else if(typeof define === 'function' && define.amd)
		define(["@deriv/components", "@deriv/shared", "@deriv/translations", "mobx", "mobx-react", "react", "react-dom", "react-router", "react-router-dom"], factory);
	else if(typeof exports === 'object')
		exports["@deriv/reports"] = factory(require("@deriv/components"), require("@deriv/shared"), require("@deriv/translations"), require("mobx"), require("mobx-react"), require("react"), require("react-dom"), require("react-router"), require("react-router-dom"));
	else
		root["@deriv/reports"] = factory(root["@deriv/components"], root["@deriv/shared"], root["@deriv/translations"], root["mobx"], root["mobx-react"], root["react"], root["react-dom"], root["react-router"], root["react-router-dom"]);
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/**\n * @constructor\n */\nfunction AggregateError(errors, message) {\n  (this.name = 'AggregateError'), (this.errors = errors);\n  this.message = message || '';\n}\nAggregateError.prototype = Error.prototype;\n\nfunction any(arr) {\n  var P = this;\n  return new P(function(resolve, reject) {\n    if (!(arr && typeof arr.length !== 'undefined')) {\n      return reject(new TypeError('Promise.any accepts an array'));\n    }\n\n    var args = Array.prototype.slice.call(arr);\n    if (args.length === 0) return reject();\n\n    var rejectionReasons = [];\n    for (var i = 0; i < args.length; i++) {\n      try {\n        P.resolve(args[i])\n          .then(resolve)\n          .catch(function(error) {\n            rejectionReasons.push(error);\n            if (rejectionReasons.length === args.length) {\n              reject(\n                new AggregateError(\n                  rejectionReasons,\n                  'All promises were rejected'\n                )\n              );\n            }\n          });\n      } catch (ex) {\n        reject(ex);\n      }\n    }\n  });\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (any);\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///../../node_modules/promise-polyfill/src/any.js\n");
...
/******/ 			return "reports/js/reports." + chunkId + "." + {"404":"df3ca6367b32070949d7","vendors-node_modules_lodash_debounce_index_js-node_modules_lodash_merge_index_js-node_modules-efce67":"49646f7dce1e58226f8f","reports-app":"2601496e8066556da92a","vendors-node_modules_classnames_index_js-node_modules_react-content-loader_dist_react-content-d9aa86":"c60318b3500d72520b59","reports-routes":"2b2abae83106119bf17b","vendors-node_modules_moment_moment_js":"cb309ae590cfa38e865c","two-month-picker":"0283b05bc9388dbe8d3e"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 			// return url for filenames based on template
/******/ 			return "reports/css/reports." + chunkId + "." + {"reports-app":"2f8bf1aba5a67d1702a2","reports-routes":"cf2d61484c59d5c65fc0"}[chunkId] + ".css";
/******/ 		};
/******/ 	})();
/******/ 	
