...
describe('getAccumulatorBarriers', () => {
    ...
    it('should return correct barriers for Vol 100 with growth_rate 0.05 for a 2-pip_size previous_spot', () => {
    ...
    it('should return correct barriers for Vol 10 (1s) with growth_rate 0.01 for a 2-pip_size previous_spot', () => {
    ...
    it('should return correct barriers for Crash 300 with growth_rate 0.05 for a 3-pip_size previous_spot', () => {
        expect(getAccumulatorBarriers(0.000019945249, 12345.456, 3)).toEqual({
            high_barrier: '12345.7023',
            low_barrier: '12345.2097',
        });
    });
    it('should return correct barriers for Jump 100 with growth_rate 0.03 for a 2-pip_size previous_spot', () => {
    ...
    it('should return correct barriers for Vol 75 with growth_rate 0.03 for a 4-pip_size previous_spot', () => {
    ...
    it('should return correct barriers for Boom 500 with growth_rate 0.02 for a 3-pip_size previous_spot', () => {
