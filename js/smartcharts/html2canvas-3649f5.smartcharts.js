...
!function (A, e) {
    ...
    this.text = dn(A.data, e.textTransform), this.textBounds = function (A, t, r) {
      ...
      return e.forEach(function (A) {
        if (t.textDecorationLine.length || 0 < A.trim().length) {
          if (Oe.SUPPORT_RANGE_BOUNDS) n.push(new Cn(A, En(r, B, A.length)));else {
  ...
  var ps = function (c, Q, w, u) {
    ...
    switch (A) {
      ...
      Rs = "Hidden Text",
      Ls = (vs.prototype.parseMetrics = function (A, e) {
...
//# sourceMappingURL=html2canvas-3649f5.smartcharts.js.map