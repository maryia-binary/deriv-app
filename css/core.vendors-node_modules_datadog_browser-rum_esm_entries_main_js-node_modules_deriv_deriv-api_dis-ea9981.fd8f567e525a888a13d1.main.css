...
.ic-icon.ciq-favorite svg, .ic-icon.ic-favorite svg, .cq-text-icon.ciq-favorite svg, .cq-text-icon.ic-favorite svg {
  fill: none !important; }

.smartcharts-light .ic-icon.ciq-favorite svg, .smartcharts-light .ic-icon.ic-favorite svg, .smartcharts-light .cq-text-icon.ciq-favorite svg, .smartcharts-light .cq-text-icon.ic-favorite svg {
  stroke: rgba(0, 0, 0, 0.8); }

.smartcharts-dark .ic-icon.ciq-favorite svg, .smartcharts-dark .ic-icon.ic-favorite svg, .smartcharts-dark .cq-text-icon.ciq-favorite svg, .smartcharts-dark .cq-text-icon.ic-favorite svg {
  stroke: #999; }

.smartcharts-light .ic-icon.ciq-active-favorite svg, .smartcharts-light .cq-text-icon.ciq-active-favorite svg {
  fill: #f93 !important;
  stroke: #f93 !important; }

.smartcharts-dark .ic-icon.ciq-active-favorite svg, .smartcharts-dark .cq-text-icon.ciq-active-favorite svg {
  fill: #f93 !important;
  stroke: #f93 !important; }

.ic-icon.margin, .cq-text-icon.margin {
  margin: 0 5px; }

.ic-icon svg, .cq-text-icon svg {
  position: relative; }

.ic-icon br, .ic-icon .ic-subtitle, .cq-text-icon br, .cq-text-icon .ic-subtitle {
  display: none; }
...
.smartcharts-light .cq-chart-controls .cq-menu-btn .ic-icon > svg, .smartcharts-light .sc-filter .ic-icon > svg, .smartcharts-light .cq-active-options .ic-icon > svg, .smartcharts-light .titlebar > .icons .ic-icon > svg, .smartcharts-light .cq-draw-button .ic-icon > svg, .smartcharts-light .cq-lookup-input .ic-icon > svg, .smartcharts-light .template-name .ic-icon > svg, .smartcharts-light .ciq-views .ciq-list-item .ic-icon > svg, .smartcharts-light .ciq-chart-dialog .ic-icon > svg, .smartcharts-light .cq-menu-dropdown .title .ic-icon > svg, .smartcharts-light .ciq-chart-types .ciq-list-item .ic-icon > svg, .smartcharts-light .sc-mcd__filter .ic-icon > svg, .smartcharts-light .sc-mcd__category__head .category-title-left .ic-icon > svg, .smartcharts-light .sc-mcd__category__head .ic-icon > svg {
  fill: rgba(0, 0, 0, 0.8);
  stroke: rgba(0, 0, 0, 0.8); }

.smartcharts-dark .cq-chart-controls .cq-menu-btn .ic-icon > svg, .smartcharts-dark .sc-filter .ic-icon > svg, .smartcharts-dark .cq-active-options .ic-icon > svg, .smartcharts-dark .titlebar > .icons .ic-icon > svg, .smartcharts-dark .cq-draw-button .ic-icon > svg, .smartcharts-dark .cq-lookup-input .ic-icon > svg, .smartcharts-dark .template-name .ic-icon > svg, .smartcharts-dark .ciq-views .ciq-list-item .ic-icon > svg, .smartcharts-dark .ciq-chart-dialog .ic-icon > svg, .smartcharts-dark .cq-menu-dropdown .title .ic-icon > svg, .smartcharts-dark .ciq-chart-types .ciq-list-item .ic-icon > svg, .smartcharts-dark .sc-mcd__filter .ic-icon > svg, .smartcharts-dark .sc-mcd__category__head .category-title-left .ic-icon > svg, .smartcharts-dark .sc-mcd__category__head .ic-icon > svg {
  fill: #999;
  stroke: #999; }
...
.smartcharts-light .cq-chart-controls .stxMenuActive .cq-menu-btn .ic-icon svg, .smartcharts-light .ciq-aggregate-setting > .ic-icon:hover svg, .smartcharts-light .cq-active-options .ic-icon:hover svg, .smartcharts-light .ciq-chart-types .ciq-list-item .active.ic-icon svg {
  fill: #2a3052;
  stroke: #2a3052; }

.smartcharts-dark .cq-chart-controls .stxMenuActive .cq-menu-btn .ic-icon svg, .smartcharts-dark .ciq-aggregate-setting > .ic-icon:hover svg, .smartcharts-dark .cq-active-options .ic-icon:hover svg, .smartcharts-dark .ciq-chart-types .ciq-list-item .active.ic-icon svg {
  fill: #fff;
  stroke: #fff; }
...
.smartcharts-light .sc-chart-mode__section__text {
  color: #333 !important; }

.smartcharts-dark .sc-chart-mode__section__text {
  color: #c2c2c2 !important; }

.sc-chart-mode__section__text--mobile {
  font-size: 11px; }
...
.smartcharts-light .ciq-period.stxMenuActive .ic-subtitle, .smartcharts-light .ciq-period.stxMenuActive .ic-priod span {
  color: #7f8397; }

.smartcharts-dark .ciq-period.stxMenuActive .ic-subtitle, .smartcharts-dark .ciq-period.stxMenuActive .ic-priod span {
  color: #fff; }
...
.sc-studies__panel--search .sc-scrollbar .sc-studies__category:first-child .sc-studies__list__item:nth-child(1) .sc-tooltip__inner, .sc-studies__panel--search .sc-scrollbar .sc-studies__category:first-child .sc-studies__list__item:nth-child(2) .sc-tooltip__inner {
  position: fixed;
  left: auto;
  top: auto;
...
.sc-studies__list__item--disabled-prediction .info {
  opacity: 0.3;
  pointer-events: none; }
...
.sc-numeric-input input[type='number']::-webkit-outer-spin-button, .sc-numeric-input input[type='number']::-webkit-inner-spin-button {
  -webkit-appearance: none;
  margin: 0; }
...
.sc-toggle > .ic-icon, .sc-chart-controls .ic-icon-with-sub {
  width: 24px;
  height: 24px; }
...
.sc-download__item--loading > .sc-download__item__label, .sc-download__item--loading > .ic-icon {
  opacity: 0.32; }
...
.ciq-chart--screenshot .calendar, .ciq-chart--screenshot .cq-menu-dropdown, .ciq-chart--screenshot .sc-toolbar-widget, .ciq-chart--screenshot .sc-navigation-widget, .ciq-chart--screenshot .stx_jump_today.home, .ciq-chart--screenshot .stx-panel-control .stx-btn-panel, .ciq-chart--screenshot .time-picker-dropdown {
  display: none !important; }
...
.stx-btn-panel:hover span, .stx-btn-panel:active span {
  opacity: 1; }
...
.stx_jump_today:hover, .stx_jump_today:active {
  opacity: 1; }
...
.overlayEdit.stx-btn, .vectorTrashCan.stx-btn {
  cursor: pointer;
  display: inline-block;
  text-align: center;
  width: 30px;
...
.smartcharts-light .overlayEdit.stx-btn, .smartcharts-light .vectorTrashCan.stx-btn {
  background: #d6dadb !important; }

.smartcharts-dark .overlayEdit.stx-btn, .smartcharts-dark .vectorTrashCan.stx-btn {
  background: #323738 !important; }

.overlayEdit.stx-btn span, .vectorTrashCan.stx-btn span {
...
.overlayEdit.stx-btn span svg, .vectorTrashCan.stx-btn span svg {
  fill: #555975; }

.overlayEdit.stx-btn span.ic-delete, .vectorTrashCan.stx-btn span.ic-delete {
  display: none; }

.overlayEdit.stx-btn span.ic-edit, .vectorTrashCan.stx-btn span.ic-edit {
  display: flex; }

.rightclick_study .overlayEdit {
  margin: 0px !important; }

.rightclick_series .overlayEdit.stx-btn > .ic-delete, .rightclick_series .vectorTrashCan.stx-btn > .ic-delete {
  display: flex; }

.rightclick_series .overlayEdit.stx-btn > .ic-edit, .rightclick_series .vectorTrashCan.stx-btn > .ic-edit {
  display: none; }
...
.stx_current_hr_up, .stx_current_hr_down {
  font-weight: bold;
  font-size: 12px;
  font-family: "IBM Plex Sans",sans-serif; }

.smartcharts-light .stx_current_hr_up, .smartcharts-light .stx_current_hr_down {
  color: #fff;
  background-color: #ff444f; }

.smartcharts-dark .stx_current_hr_up, .smartcharts-dark .stx_current_hr_down {
  color: #fff;
  background-color: #ff444f; }
...
.smartcharts-light .stx-float-price, .smartcharts-light .stx-float-date {
  color: #333 !important; }

.smartcharts-light .stx-float-price, .smartcharts-light .stx-float-date {
  background-color: #d6dadb; }

.smartcharts-dark .stx-float-price, .smartcharts-dark .stx-float-date {
  color: #fff !important; }
...
.smartcharts-light .stx_line_chart, .smartcharts-light .stx_bar_chart {
  color: #7f8397; }

.smartcharts-dark .stx_line_chart, .smartcharts-dark .stx_bar_chart {
  color: #fff; }
...
.annotationSave, .annotationCancel, .stx-btn.stx_annotation_save, .stx-btn.stx_annotation_cancel {
  position: absolute;
  display: none;
  font-size: 11px;
...
.smartcharts-light .stx_yaxis, .smartcharts-light .stx_xaxis, .smartcharts-light .stx_xaxis_dark {
  color: #555975; }

.smartcharts-dark .stx_yaxis, .smartcharts-dark .stx_xaxis, .smartcharts-dark .stx_xaxis_dark {
  color: #999; }
...
.smartcharts-light .annotationCancel, .smartcharts-light .annotationSave {
  background: #fff;
  color: rgba(0, 0, 0, 0.8); }

.smartcharts-dark .annotationCancel, .smartcharts-dark .annotationSave {
  background: #0e0e0e;
  color: #999; }

.annotationCancel:hover, .annotationSave:hover {
  border: none;
  box-shadow: 0 1px 2px rgba(0, 0, 0, 0.3); }

.annotationCancel:active, .annotationSave:active {
  border: none;
...
.ciq-chart-area, .ciq-chart, .stx-panel-side {
  box-sizing: border-box; }
...
.smartcharts-light .smartcharts input::placeholder, .smartcharts-light .smartcharts input::-moz-placeholder {
  color: #7f8397; }

.smartcharts-dark .smartcharts input::-moz-placeholder {
  color: #fff; }

.smartcharts-dark .smartcharts input::placeholder, .smartcharts-dark .smartcharts input::-moz-placeholder {
  color: #fff; }
...
.smartcharts-mobile .ciq-menu .cq-menu-btn:hover > .ic-icon svg, .smartcharts-mobile .ciq-menu .cq-menu-btn:hover > .cq-toggle svg {
  background: transparent; }
...
.smartcharts-mobile .cq-modal-dropdown.ciq-studies .cq-modal__overlay .cq-menu-dropdown, .smartcharts-mobile .cq-modal-dropdown.cq-comparison-new .cq-modal__overlay .cq-menu-dropdown, .smartcharts-mobile .cq-modal-dropdown.cq-chart-title .cq-modal__overlay .cq-menu-dropdown {
  height: 100%; }

.smartcharts-mobile .cq-modal-dropdown.ciq-studies .cq-modal__overlay .cq-menu-dropdown .title, .smartcharts-mobile .cq-modal-dropdown.cq-comparison-new .cq-modal__overlay .cq-menu-dropdown .title, .smartcharts-mobile .cq-modal-dropdown.cq-chart-title .cq-modal__overlay .cq-menu-dropdown .title {
...
.smartcharts-mobile .cq-menu-dropdown.open .icon-close-menu, .smartcharts-mobile .cq-menu-dropdown.cq-menu-dropdown-enter-done .icon-close-menu {
  pointer-events: initial;
  opacity: 1; }
...
.sc-input::placeholder, .sc-input::-moz-placeholder {
  font-size: 14px; }

.smartcharts-light .sc-input::-moz-placeholder {
  color: #999; }

.smartcharts-light .sc-input::placeholder, .smartcharts-light .sc-input::-moz-placeholder {
  color: #999; }
...
.sc-loader .sc-loader-spin, .cq-comparison-loader, .cq-loading {
...
.smartcharts-dark .sc-loader .sc-loader-spin, .smartcharts-dark .cq-comparison-loader, .smartcharts-dark .cq-loading {
...
.smartcharts-light .cq-chart-controls .ciq-menu.ciq-enabled.stxMenuActive .cq-menu-btn > .ic-icon, .smartcharts-light .cq-chart-controls .ciq-menu.ciq-enabled.stxMenuActive .cq-menu-btn > .cq-toggle {
  color: #7f8397; }

.smartcharts-dark .cq-chart-controls .ciq-menu.ciq-enabled.stxMenuActive .cq-menu-btn > .ic-icon, .smartcharts-dark .cq-chart-controls .ciq-menu.ciq-enabled.stxMenuActive .cq-menu-btn > .cq-toggle {
  color: #fff; }

.cq-chart-controls .ciq-menu.ciq-enabled.stxMenuActive .cq-menu-btn > .ic-icon .ic-subtitle, .cq-chart-controls .ciq-menu.ciq-enabled.stxMenuActive .cq-menu-btn > .cq-toggle .ic-subtitle {
  display: none;
  font-weight: bold; }

.smartcharts-light .cq-chart-controls .ciq-menu.ciq-enabled.stxMenuActive .cq-menu-btn > .ic-icon .ic-subtitle, .smartcharts-light .cq-chart-controls .ciq-menu.ciq-enabled.stxMenuActive .cq-menu-btn > .cq-toggle .ic-subtitle {
  color: #7f8397; }

.smartcharts-dark .cq-chart-controls .ciq-menu.ciq-enabled.stxMenuActive .cq-menu-btn > .ic-icon .ic-subtitle, .smartcharts-dark .cq-chart-controls .ciq-menu.ciq-enabled.stxMenuActive .cq-menu-btn > .cq-toggle .ic-subtitle {
  color: #fff; }
...
.cq-chart-controls .ciq-menu .cq-menu-btn > .ic-icon.active .ic-subtitle, .cq-chart-controls .ciq-menu .cq-menu-btn > .cq-toggle.active .ic-subtitle {
  font-weight: bold; }

.smartcharts-light .cq-chart-controls .ciq-menu .cq-menu-btn > .ic-icon.active .ic-subtitle, .smartcharts-light .cq-chart-controls .ciq-menu .cq-menu-btn > .cq-toggle.active .ic-subtitle {
  color: #7f8397; }

.smartcharts-dark .cq-chart-controls .ciq-menu .cq-menu-btn > .ic-icon.active .ic-subtitle, .smartcharts-dark .cq-chart-controls .ciq-menu .cq-menu-btn > .cq-toggle.active .ic-subtitle {
  color: #fff; }

.cq-chart-controls .ciq-menu .cq-menu-btn > .ic-icon .ic-subtitle, .cq-chart-controls .ciq-menu .cq-menu-btn > .cq-toggle .ic-subtitle {
  display: none;
  font-weight: normal;
  line-height: normal;
  text-align: center;
...
.smartcharts-light .cq-chart-controls .ciq-menu .cq-menu-btn > .ic-icon .ic-subtitle, .smartcharts-light .cq-chart-controls .ciq-menu .cq-menu-btn > .cq-toggle .ic-subtitle {
  color: rgba(0, 0, 0, 0.8); }

.smartcharts-dark .cq-chart-controls .ciq-menu .cq-menu-btn > .ic-icon .ic-subtitle, .smartcharts-dark .cq-chart-controls .ciq-menu .cq-menu-btn > .cq-toggle .ic-subtitle {
  color: #999; }
...
.smartcharts-mobile .cq-chart-controls .bt-priod, .smartcharts-mobile .cq-chart-controls .cq-toggle, .smartcharts-mobile .cq-chart-controls .cq-menu-btn, .smartcharts-mobile .cq-chart-controls .sc-chart-size > span {
  padding: 0 !important; }
...
.smartcharts-light .cq-chart-title .cq-symbol-select-btn .cq-chart-price, .smartcharts-light .cq-chart-title .cq-symbol-select-btn .cq-chart-closed {
  color: #999; }

.smartcharts-dark .cq-chart-title .cq-symbol-select-btn .cq-chart-price, .smartcharts-dark .cq-chart-title .cq-symbol-select-btn .cq-chart-closed {
  color: #999; }
...
.sc-mcd__category__head.sticky-top, .sc-mcd__category__head.sticky-bottom {
  z-index: 8;
  padding-top: 0px;
  height: 40px; }

.smartcharts-light .sc-mcd__category__head.sticky-top, .smartcharts-light .sc-mcd__category__head.sticky-bottom {
  background-color: #fff;
  border-bottom: 1px solid #fff; }

.smartcharts-dark .sc-mcd__category__head.sticky-top, .smartcharts-dark .sc-mcd__category__head.sticky-bottom {
  background-color: #0e0e0e;
  border-bottom: 1px solid #0e0e0e; }

.sc-mcd__category__head.sticky-top.has-subtitle, .sc-mcd__category__head.sticky-bottom.has-subtitle {
  height: 60px; }
...
.sc-mcd__category__content .subcategory .ic-icon svg {
  width: 16px;
  height: 16px; }

.smartcharts-light .sc-mcd__category__content .subcategory .ic-icon svg {
  fill: #333; }

.smartcharts-dark .sc-mcd__category__content .subcategory .ic-icon svg {
  fill: #c2c2c2; }
...
.stx-crosshair-on .cq-crosshair .cq-crosshair-content:after, .stx-crosshair-on .cq-crosshair .cq-crosshair-content:before {
  content: '';
  position: absolute;
  top: calc(50% - 4px);
  width: 0;
...
.stx-crosshair-on .cq-crosshair.arrow-left .cq-crosshair-content:after, .stx-crosshair-on .cq-crosshair.arrow-right .cq-crosshair-content:before {
  display: block; }
